...
use Reactor\Hierarchy\Builders\MigrationBuilder;
...
if ( ! function_exists('source_model_name'))
{
    ...
    function source_model_name($key, $withPath = false)
    {
       ...
       // dd($withPath ? 'gen\\Entities\\' . $name : $name);
...
if ( ! function_exists('get_node_by_id'))
{
    ...
    {
        return app()->make('Reactor\Hierarchy\NodeRepository')
...

{
    ...
    {
        return app()->make('Reactor\Hierarchy\Repositories\NodeTypeRepository')
