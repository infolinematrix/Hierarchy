...
use Reactor\Hierarchy\Builders\BuilderService;
...
class BuilderServiceTest extends TestBase {
    ...
    {
        $modelBuilder = $this->prophesize('Reactor\Hierarchy\Contract\Builders\ModelBuilderContract');
        $modelBuilder->build('project')
            ->willReturn(null)
            ->shouldBeCalled();

        $formBuilder = $this->prophesize('Reactor\Hierarchy\Contract\Builders\FormBuilderContract');
        $formBuilder->build('project')
            ->willReturn(null)
            ->shouldBeCalled();

        $migrationBuilder = $this->prophesize('Reactor\Hierarchy\Contract\Builders\MigrationBuilderContract');
    ...
    {
        $model = $this->prophesize('Reactor\Hierarchy\Contract\NodeTypeContract');
